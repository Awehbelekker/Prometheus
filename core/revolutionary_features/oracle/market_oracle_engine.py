...
try:
    ...
    logger.warning("RAGFlow not available - using enhanced oracle without knowledge retrieval")
...
class MarketOracleEngine:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info("🔮 Market Oracle Engine initialized with RAGFlow enhancement")
