"""Sell IB CRM Position Now - Synchronous Version"""
from ib_insync import IB, Stock, MarketOrder
import time

def sell_crm_position():
    ...
    try:
        ...
        if not current_price:
            current_price = ticker.bid if ticker.bid else 248.0  # Fallback
        ...
        # Create sell order
        print(f"\n🚀 Placing SELL order for {int(qty)} CRM shares...")
        
        sell_order = MarketOrder('SELL', int(qty))
